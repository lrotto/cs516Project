...
$username = $password  = "";
$usernameerr = $passworderr  = $loginerr = $fname = "";
		...
		<div id="left"> 
			<div  class="formcol" id="formtext">
				<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
					...
					<label for="username">Username:&nbsp <input type="text" id="username" name="username" value = "<?php echo $username;?>" autofocus<br>
					<span class="error">*&nbsp<br> <?php echo $usernameerr;?></span>
					<br><br>
					<label for="password">Password:&nbsp <input type="password" id="password" name="password" value = "<?php echo $password;?>" autofocus<br>
					<span class="error">*&nbsp<br> <?php echo $passworderr;?></span>
					<br><br>
					</span>
