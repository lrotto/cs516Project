	...
	<div  class="sctextalign" id="formtext">
		...
		<table style="width:50%" id="t01">
			...
			<col width="10%">
			  ...
			  <tr>
				<td><input type="checkbox" name = "check_list[0]" value = 9></td>
				<td>Creative Code</td> 
				<td class="colpicalign"><img src="bookpics/creativecode.jpg" alt="Creative Code"/></td>
			  </tr>

			  <tr>
				<td><input type="checkbox" name = "check_list[1]" value = 10></td>
			   <td>Coding as a Playground</td> 
				<td class="colpicalign"><img src="bookpics/codingplay.jpg" alt="Coding as a Playground"/></td>
			  </tr>
		</table>
	</div>
	<div  class="sctextalign" id="formtext">
